...
export function closeModal(e) {
  if (e.target === document.getElementById('destModal')) document.getElementById('destModal').classList.remove('show');
}
...
export function closeDrawer() { document.getElementById('drawer').classList.remove('open'); document.getElementById('overlay').classList.remove('show'); }
...
export function toggleFaq(item) { item.classList.toggle('open'); }
...
export function submitContact(e) {
  ...
  const data = {
    type: 'Contact Message', transactionId: 'MSG-' + Date.now(),
    name: form.name.value, email: form.email.value,
